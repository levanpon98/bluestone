            ...
            <div className="ps-container">
                <div className="ps-section__content">
                    ...
                    <div className="image-top mb-70">
                        <img src="/static/img/icons/Scroll Group 5.png" alt="" width="100%" style={{maxHeight:"1000px"}}/>
                    </div>
                    ...
                    <div className="image-top mb-70">
                        <img src="/static/img/icons/Image 19.png" alt="" width="100%" style={{maxHeight:"1000px"}}/>
                    </div>
                    <div className="mb-70 title-aboutus" >
                    ...
                    <div className="image-top mb-70">
                        <img src="/static/img/icons/Scroll Group 2.png" alt="" width="100%" style={{maxHeight:"1000px"}}/>
                    </div>
                </div>
            </div>
        </div>
